...
> 🤖 基于 OpenClaw AI 框架的智能虚拟员工系统，支持企业微信和 Telegram 集成

## 📖 项目简介

OpenClaw 企业微信虚拟员工系统提供多角色 AI 助手，支持企业微信和 Telegram 双平台接入：
- 🎯 **调度员** - 智能任务分发
- 📊 **运营专员** - 运营数据分析
- 🎨 **产品经理** - 产品需求管理
- 💻 **开发工程师** - 技术支持
...
├── 07-故障排查.md           # 🔧 问题诊断指南
├── 11-Telegram配置.md       # 📱 Telegram Bot 配置（V1.4 新增）
├── 12-Telegram部署.md       # 🚀 Telegram Bot 部署（V1.4 新增）
└── 13-Telegram使用指南.md   # 💬 Telegram Bot 使用（V1.4 新增）
```
