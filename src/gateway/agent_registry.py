...
AGENT_REGISTRY = {
    "operation": {
        ...
        "container": os.getenv("AGENT_OPERATION_CONTAINER", "openclaw-agent-operation"),
        "name": "运营专员",
        "desc": "数据分析、运营策略、用户增长",
    },
    "product": {
        "url": os.getenv("AGENT_PRODUCT_URL", "http://localhost:18792"),
        "container": os.getenv("AGENT_PRODUCT_CONTAINER", "openclaw-agent-product"),
        "name": "产品经理",
        "desc": "需求管理、产品规划、用户故事",
    },
    "development": {
        "url": os.getenv("AGENT_DEVELOPMENT_URL", "http://localhost:18793"),
        "container": os.getenv("AGENT_DEVELOPMENT_CONTAINER", "openclaw-agent-development"),
        "name": "开发工程师",
        "desc": "代码实现、技术架构、Bug修复",
    },
    "testing": {
        "url": os.getenv("AGENT_TESTING_URL", "http://localhost:18794"),
        "container": os.getenv("AGENT_TESTING_CONTAINER", "openclaw-agent-testing"),
        "name": "测试工程师",
        "desc": "测试用例、质量保障、缺陷管理",
    },
    "service": {
        "url": os.getenv("AGENT_SERVICE_URL", "http://localhost:18795"),
        "container": os.getenv("AGENT_SERVICE_CONTAINER", "openclaw-agent-service"),
        "name": "客服专员",
        "desc": "客户服务、问题解答、投诉处理",
    },
}
